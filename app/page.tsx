  ...
  return (
    <main className='mx-auto max-w-screen-lg'>
      ...
      <section id="about" className='mt-40'>
        <div className="flex align-middle justify-between gap-16">
          ...
          <div className="w-full">
            ...
            <div className="mt-20 mb-32">
              {/* <div className="flex gap-3 items-center">
                <Image src={"/images/code.jpeg"} height="200" width="600" className="rounded-md aspect-video w-1/2 object-cover object-center" alt="" />
                <div className="flex flex-col items-end w-1/2 relative">
                  <p className="text-base text-green-500 font-bold">Featured Project</p>
                  <div className="-ml-20 p-5 shadow-theme bg-theme-light rounded-md w-full" style={{ width: "calc(100% + 80px)" }}>
                    <p className="text-white">dadmad  dmamdman damdamndm</p>
                  </div>
                </div>
              </div> */}
              <FeaturedProjectItem />
